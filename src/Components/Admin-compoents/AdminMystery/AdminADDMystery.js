...
const AdminADDMystery = () => {
  ...
  const HandleSubmit = (e) => {
    e.preventDefault();
    dispatch(createMystery(formData));
    setFormData({
      Title: "",
      Image: [],
      Status: "",
  ...
  return (
    ...
    //   </form>
    // </div>
    <div class=" w-full h-full rounded-start-5 p-2 overflow-y-auto">
      <form class="w-full mt-3 p-2" method="post" onSubmit={HandleSubmit}>
        <div class="Addteacherimage_box">
          {formData.Image?.map((md, index) => {
            return (
              <div
                class="col-6 sm:col-6 lg:col-3 mt-2 sm:mt-0 mb-0 sm:mb-2"
                key={index}
              >
                <img
                  class="w-full active"
                ...
                <span
                  class="badge bg-red-500 rounded-pill ml-1 cursor-pointer"
                  onClick={() => handleImageRemoval(md, index, "Image")}
                >
                  Delete
                </span>
        ...
        {/* Image input Links */}
        {formData.Image?.length < 10 && (
          <div class="col-6 sm:col-6 lg:col-3 mt-2 sm:mt-0 mb-0 sm:mb-2">
            <div class="card-body">
        ...
        <div class="flex w-full bg-gray-200 justify-between mt-2">
          <input
            type="text"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/4"
            id="Title"
            name="Title"
            placeholder="Title"
            value={formData.Title}
            ...
            required
          />
          <div class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/4">
        ...
        {/* ---------------------------------------------------------------------------------------------------  Wordexplore  ------------------------------------ */}
        <h6 class="text-left mt-2 p-1">Wordexplore</h6>
        {formData.Wordexplore.map((wordexplore, index) => (
          <div class="mt-2" key={index}>
            ...
            <div class="flex w-full bg-gray-200 justify-between mt-2">
              ...
              {index !== 0 && (
                <button
                  class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 mx-1.5 initialpadding"
                  onClick={() => handleRemoveWordexplore(index)}
                >
                  Delete Wordexplore
                </button>
            ...
            {index === formData.Wordexplore.length - 1 && (
              <button
                class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 mx-1.5 mt-2 initialpadding"
                onClick={handleAddWordexplore}
              >
                Add More Wordexplore
              </button>
        ...
        {/* ---------------------------------------------------------------------------------------------------  Storyadvenure  ------------------------------------ */}
        <h6 class="text-left mt-2 p-1">Storyadvenure</h6>
        <div class="flex w-full bg-gray-200 justify-between mt-2">
          <input
            type="text"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/4"
        ...
        {formData.Storyadvenure.content.map((storyadvenure, index) => (
          <div class="mt-2" key={index}>
            ...
            {storyadvenure.Paragraph.map((paragraph, pIndex) => (
              <div
                class="flex w-full bg-gray-200 justify-between mt-2"
                key={pIndex}
              >
                <input
                  type="text"
            ...
            {index !== 0 && (
              <button
                class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 mx-1.5 initialpadding mt-2"
                onClick={() => handleRemoveStoryadvenure(index)}
              >
                Delete Wordexplore
              </button>
        ...
        {/* ---------------------------------------------------------------------------------------------------  Wordexplore  ------------------------------------ */}
        <h6 class="text-left mt-2 p-1">Brainquest</h6>
        {formData.Brainquest.map((brainquest, index) => (
          <div class="mt-2" key={index}>
            <input
              type="text"
        ...
        <button
          type="submit"
          class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 mx-1.5 mt-4"
        >
          Submit the Mystery
        </button>
      </form>
...
export default AdminADDMystery;
