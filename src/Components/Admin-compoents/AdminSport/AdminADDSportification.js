...
import {
  createSportification,
  imageUpload,
} from "../../../store/Actions/adminActions";
import { useNavigate } from "react-router-dom";

const AdminADDSportification = () => {
  ...
  const HandleSubmit = (e) => {
    e.preventDefault();
    dispatch(createSportification(formData));
    setFormData({
      Title: "",
      Image: [],
      Status: "",
    ...
    navigate("/Admin/Admin-Sportification");
  };
    ...
    <div className="w-full h-full rounded-start-5 p-2 overflow-y-auto">
      <form className="w-full mt-3 p-2" method="post" onSubmit={HandleSubmit}>
        <div className="flex flex-wrap -mx-2">
          {formData.Image?.map((md, index) => (
            <div
              className="w-full sm:w-1/2 lg:w-1/4 px-2 mt-2 md:mt-0 mb-2"
              key={index}
            >
              <img
                className="w-full"
              ...
              />
              <span
                className="badge bg-danger badge-pill badge-round ml-1 cursor-pointer"
                onClick={() => handleImageRemoval(md, index, "Image")}
              >
                Delete
              </span>
        ...
        {formData.Image?.length < 10 && (
          <div className="w-full sm:w-1/2 lg:w-1/4 mt-2 md:mt-0 mb-2">
            <div className="card-body">
              <p className="text-sm">
                Select image file to upload on the cover of the fanstasy.
              </p>
        ...
        <div className="flex w-full bg-gray-200 justify-between mt-2">
          <input
            type="text"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/4 p-2"
            id="Title"
            name="Title"
            placeholder="Title"
            value={formData.Title}
        ...
        <h6 className="text-left mt-2 p-1">Wordexplore</h6>
        {formData.Wordexplore.map((wordexplore, index) => (
          <div className="mt-2" key={index}>
            <div className="flex flex-wrap -mx-2">
              {wordexplore.Storyimage?.map((md, imgIndex) => (
            ...
            <div className="flex w-full bg-gray-200 justify-between mt-2">
              ...
              {index !== 0 && (
                <button
                  className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 mx-1.5 initialpadding p-2"
                  onClick={() => handleRemoveWordexplore(index)}
                >
                  Delete Wordexplore
                </button>
            ...
            {index === formData.Wordexplore.length - 1 && (
              <button
                className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 mx-1.5 mt-2 initialpadding p-2"
                onClick={handleAddWordexplore}
              >
                Add More Wordexplore
              </button>
        ...
        {/* Storyadvenure */}
        <h6 className="text-left mt-2 p-1">Storyadvenure</h6>
        <div className="flex w-full bg-gray-200 justify-between mt-2">
          <input
            type="text"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/4 p-2"
        ...
        {formData.Storyadvenure.content.map((storyadvenure, index) => (
          <div className="mt-2" key={index}>
            ...
            {storyadvenure.Paragraph.map((paragraph, pIndex) => (
              <div
                className="flex w-full bg-gray-200 justify-between mt-2"
                key={pIndex}
              >
                <input
                  type="text"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/2 p-2"
                  placeholder="Paragraph"
                  value={paragraph}
                  onChange={(e) => handleParagraphChange(e, index, pIndex)}
                  required
            ...
            {index !== 0 && (
              <button
                className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 mx-1.5 initialpadding mt-2 p-2"
                onClick={() => handleRemoveStoryadvenure(index)}
              >
                Delete Wordexplore
              </button>
        ...
        {/* Brainquest */}
        <h6 className="text-left mt-2 p-1">Brainquest</h6>
        {formData.Brainquest.map((brainquest, index) => (
          <div className="mt-2" key={index}>
            <input
              type="text"
        ...
        <button
          type="submit"
          className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 mx-1.5 mt-4"
        >
          Submit the Sportification
        </button>
      </form>
...
export default AdminADDSportification;
