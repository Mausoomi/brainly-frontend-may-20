...
const AdminADDAdventure = () => {
  ...
  return (
    ...
    //   </form>
    // </div>
    <div className="h-full rounded-start-5 p-2 overflow-y-auto">
      <form className="w-full mt-3 p-2" method="post" onSubmit={HandleSubmit}>
        ...
        <div className="flex items-center justify-between bg-light mt-2">
          <input
            type="text"
        ...
        {formData.Storyadvenure.content.map((storyadvenure, index) => (
          <div className="mt-2" key={index}>
            ...
            {storyadvenure.Paragraph.map((paragraph, pIndex) => (
              <div
                className="flex items-center justify-between bg-light mt-2"
                key={pIndex}
              >
                <input
                  type="text"
                ...
                {pIndex !== 0 && (
                  <button
                    className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-2 initialpadding mx-1.5"
                    onClick={() => handleRemoveParagraph(index, pIndex)}
                  >
                    Delete Paragraph
                  </button>
            ...
            {index !== 0 && (
              <button
                className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded initialpadding mt-2 mx-1.5"
                onClick={() => handleRemoveStoryadvenure(index)}
              >
                Delete Storyadventure
              </button>
            )}
            {index === formData.Storyadvenure.content.length - 1 && (
              <button
        ...
        {formData.Brainquest.map((brainquest, index) => (
          <div className="mt-2" key={index}>
            ...
            {index !== 0 && (
              <button
                className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded initialpadding mx-1.5"
                onClick={() => handleRemoveBrainquest(index)}
              >
                Delete Brainquest
              </button>
        ...
        <button
          type="submit"
          className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mt-4 mx-1.5"
        >
          Submit the Adventure
        </button>
      </form>
...
export default AdminADDAdventure;
